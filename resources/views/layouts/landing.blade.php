...
<body class="bg-gray-50 text-gray-800">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-3">
                    <x-language-switcher />
                    <a href="{{ route('login') }}" class="inline-flex items-center gap-2 text-gray-600 hover:text-green-600 px-4 py-2.5 rounded-xl transition-all duration-200 hover:bg-green-50 border border-gray-200 hover:border-green-200 shadow-sm hover:shadow-md font-medium text-sm" title="{{ __('navbar.admin_login') }}">
            ...
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200 shadow-lg">
                ...
                <div class="pt-4 border-t border-gray-200 space-y-3">
                    ...
                    <div class="flex justify-center space-x-2">
                        <a href="{{ route('lang.switch', 'id') }}" @click="mobileMenuOpen = false" class="flex items-center gap-2 px-3 py-2 text-sm text-gray-600 hover:text-green-600 hover:bg-green-50 rounded-lg transition-colors {{ app()->getLocale() === 'id' ? 'text-green-600 bg-green-50' : '' }}">
                            <span class="text-xs font-semibold">ID</span>
                            <span>Indonesia</span>
                        </a>
                        <a href="{{ route('lang.switch', 'en') }}" @click="mobileMenuOpen = false" class="flex items-center gap-2 px-3 py-2 text-sm text-gray-600 hover:text-green-600 hover:bg-green-50 rounded-lg transition-colors {{ app()->getLocale() === 'en' ? 'text-green-600 bg-green-50' : '' }}">
                            <span class="text-xs font-semibold">EN</span>
                            <span>English</span>
                        </a>
                    </div>
                    
                    <a href="{{ route('login') }}" @click="mobileMenuOpen = false" class="text-gray-600 hover:text-green-600 flex items-center justify-center w-full px-4 py-3 rounded-lg text-base font-medium transition-all duration-200 border border-gray-200 hover:border-green-200 hover:bg-green-50 shadow-sm hover:shadow-md" title="{{ __('navbar.admin_login') }}">
    ...
    <section class="bg-gradient-to-br from-green-50 via-white to-green-100">
        <div class="max-w-7xl mx-auto px-4 py-12 md:py-20 grid md:grid-cols-2 gap-8 items-center">
            <div class="text-center md:text-left order-2 md:order-1">
                <div class="inline-flex items-center gap-2 bg-white shadow-sm rounded-full px-4 py-1 text-sm text-green-700 border border-green-100"><span class="w-2 h-2 rounded-full bg-green-500"></span>{{ __('landing.hero_tagline') }}</div>
                <h2 class="mt-6 text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-green-800">{{ __('landing.hero_title') }}</h2>
                <p class="mt-4 text-base md:text-lg text-gray-600 md:max-w-xl">{{ __('landing.hero_description') }}</p>
                <div class="mt-8 flex flex-col sm:flex-row items-center md:justify-start justify-center gap-4">
                    <button onclick="document.getElementById('complaintDialog').showModal()" class="w-full sm:w-auto bg-green-600 text-white px-6 py-3 rounded-xl font-semibold shadow hover:bg-green-700 transition">{{ __('landing.hero_cta_report') }}</button>
                    <a href="#fitur" class="w-full sm:w-auto px-6 py-3 rounded-xl font-semibold border border-green-200 text-green-700 hover:bg-white shadow-sm transition text-center">{{ __('landing.hero_cta_learn') }}</a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                ...
                <div class="flex items-center justify-center gap-4 bg-white p-4 rounded-xl shadow-sm">
                    ...
                    <div class="text-left">
                        ...
                        <div class="text-sm md:text-base text-slate-500 font-medium">{{ __('landing.stats_complaints') }}</div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-center gap-4 bg-white p-4 rounded-xl shadow-sm">
                    ...
                    <div class="text-left">
                        ...
                        <div class="text-sm md:text-base text-slate-500 font-medium">{{ __('landing.stats_bins') }}</div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-center gap-4 bg-white p-4 rounded-xl shadow-sm sm:col-span-2 lg:col-span-1">
                    ...
                    <div class="text-left">
                        ...
                        <div class="text-sm md:text-base text-slate-500 font-medium">{{ __('landing.stats_locations') }}</div>
                    </div>
                </div>
    ...
    <section id="fitur" class="max-w-7xl mx-auto px-4 py-20">
        <div class="text-center">
            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">{{ __('landing.features_title') }}</h2>
            <div class="mt-3 mx-auto h-1 w-24 bg-green-500 rounded"></div>
            <p class="mt-6 text-lg leading-8 text-gray-600 max-w-2xl mx-auto">{{ __('landing.features_subtitle') }}</p>
        </div>
        <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            ...
            <div class="flex flex-col items-start bg-white p-8 rounded-2xl shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                ...
                <h3 class="mt-6 text-xl font-semibold leading-7 text-gray-900">{{ __('landing.feature_1_title') }}</h3>
                <p class="mt-4 text-base leading-7 text-gray-600">{{ __('landing.feature_1_description') }}</p>
            </div>
            ...
            <div class="flex flex-col items-start bg-white p-8 rounded-2xl shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                ...
                <h3 class="mt-6 text-xl font-semibold leading-7 text-gray-900">{{ __('landing.feature_2_title') }}</h3>
                <p class="mt-4 text-base leading-7 text-gray-600">{{ __('landing.feature_2_description') }}</p>
            </div>
            ...
            <div class="flex flex-col items-start bg-white p-8 rounded-2xl shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                ...
                <h3 class="mt-6 text-xl font-semibold leading-7 text-gray-900">{{ __('landing.feature_3_title') }}</h3>
                <p class="mt-4 text-base leading-7 text-gray-600">{{ __('landing.feature_3_description') }}</p>
            </div>
        </div>
    </section>
    ...
    <section id="jadwal" class="bg-gray-100 py-16">
        <div class="max-w-7xl mx-auto px-4">
            <h3 class="text-2xl font-bold text-center mb-2">{{ __('landing.schedule_title') }}</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                @empty
                    <div class="lg:col-span-3 text-center text-gray-500 py-8"><p>{{ __('landing.schedule_empty') }}</p></div>
                @endforelse
            </div>
            @if($schedules->isNotEmpty())
            <div class="text-center mt-10">
                <a href="{{ route('schedules.public.index') }}" class="px-6 py-3 rounded-xl font-semibold border border-green-200 text-green-700 hover:bg-white shadow-sm transition">{{ __('landing.schedule_view_all') }}</a>
            </div>
            @endif
        </div>
    </section>
    ...
    <section id="edukasi" class="max-w-7xl mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            @empty
                <div class="lg:col-span-3 text-center text-gray-500 py-8"><p>{{ __('landing.education_empty') }}</p></div>
            @endforelse
        </div>
        <!-- KODE YANG DIPERBAIKI: Tombol "Lihat Semua" untuk Edukasi -->
        @if($articles->isNotEmpty())
        <div class="text-center mt-10">
            <a href="{{ route('educations.public.index') }}" class="px-6 py-3 rounded-xl font-semibold border border-green-200 text-green-700 hover:bg-white shadow-sm transition">{{ __('landing.education_view_all') }}</a>
        </div>
        @endif
    </section>
    ...
    <section id="tentang" class="max-w-7xl mx-auto px-4 py-16">
        ...
        <p class="text-center text-gray-600 max-w-3xl mx-auto">{{ __('landing.about_description') }}</p>
    </section>
    ...
    <section id="faq" class="max-w-7xl mx-auto px-4 py-16">
        ...
        <div class="max-w-3xl mx-auto space-y-3" x-data="{ open: null }">
            <div class="bg-white border border-gray-200 rounded-xl"><button class="w-full text-left px-4 py-3 font-medium flex justify-between items-center" @click="open = open === 1 ? null : 1">{{ __('landing.faq_1_question') }}<span x-text="open === 1 ? '-' : '+'"></span></button><div x-show="open === 1" x-collapse class="px-4 pb-4 text-gray-600">{{ __('landing.faq_1_answer') }}</div></div>
            <div class="bg-white border border-gray-200 rounded-xl"><button class="w-full text-left px-4 py-3 font-medium flex justify-between items-center" @click="open = open === 2 ? null : 2">{{ __('landing.faq_2_question') }}<span x-text="open === 2 ? '-' : '+'"></span></button><div x-show="open === 2" x-collapse class="px-4 pb-4 text-gray-600">{{ __('landing.faq_2_answer') }}</div></div>
            <div class="bg-white border border-gray-200 rounded-xl"><button class="w-full text-left px-4 py-3 font-medium flex justify-between items-center" @click="open = open === 3 ? null : 3">{{ __('landing.faq_3_question') }}<span x-text="open === 3 ? '-' : '+'"></span></button><div x-show="open === 3" x-collapse class="px-4 pb-4 text-gray-600">{{ __('landing.faq_3_answer') }}</div></div>
        </div>
    </section>
    ...
    <section id="kontak" class="bg-gray-100 py-16">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div class="space-y-8">
                    <div>
                        <h4 class="text-xl font-semibold text-gray-800 mb-4">{{ __('landing.contact_details') }}</h4>
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h5 class="font-semibold text-gray-700">{{ __('landing.contact_address') }}</h5>
                                <p class="text-gray-600">{{ __('landing.contact_address_value') }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h5 class="font-semibold text-gray-700">{{ __('landing.contact_email') }}</h5>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h5 class="font-semibold text-gray-700">{{ __('landing.contact_phone') }}</h5>
    ...
    <dialog id="complaintDialog" class="backdrop:bg-black/50 rounded-xl p-0 max-w-lg w-[90vw] m-auto">
        <div class="bg-white rounded-xl p-6 w-full">
            <h3 class="text-xl font-bold text-center mb-4">{{ __('landing.complaint_title') }}</h3>
            @if ($errors->any())<div class="mb-4 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-md" role="alert"><strong class="font-bold">{{ __('landing.complaint_error_title') }}</strong><ul class="mt-2 list-disc list-inside text-sm">@foreach ($errors->all() as $error)<li>{{ $error }}</li>@endforeach</ul></div>@endif
            <form action="{{ route('complaints.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                ...
                <div><label for="reporter_name" class="block text-sm font-medium">{{ __('landing.complaint_name') }}</label><input type="text" id="reporter_name" name="reporter_name" value="{{ old('reporter_name') }}" class="w-full border rounded-lg px-3 py-2 mt-1" required></div>
                <div><label for="reporter_phone" class="block text-sm font-medium">{{ __('landing.complaint_phone') }}</label><input type="tel" id="reporter_phone" name="reporter_phone" value="{{ old('reporter_phone') }}" class="w-full border rounded-lg px-3 py-2 mt-1"></div>
                <div><label for="address_detail" class="block text-sm font-medium">{{ __('landing.complaint_address') }}</label><input type="text" id="address_detail" name="address_detail" value="{{ old('address_detail') }}" class="w-full border rounded-lg px-3 py-2 mt-1" required></div>
                <div><label for="category" class="block text-sm font-medium">{{ __('landing.complaint_category') }}</label><select id="category" name="category" class="w-full border rounded-lg px-3 py-2 mt-1" required>@foreach(__('landing.complaint_categories') as $key => $value)<option value="{{ $key }}">{{ $value }}</option>@endforeach</select></div>
                <div><label for="description" class="block text-sm font-medium">{{ __('landing.complaint_description') }}</label><textarea id="description" name="description" rows="4" class="w-full border rounded-lg px-3 py-2 mt-1" required>{{ old('description') }}</textarea></div>
                <div><label for="photo" class="block text-sm font-medium">{{ __('landing.complaint_photo') }}</label><input type="file" id="photo" name="photo" accept="image/*" class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100"></div>
                <div class="flex justify-end space-x-3 pt-2"><button type="button" onclick="document.getElementById('complaintDialog').close()" class="px-4 py-2 rounded-lg bg-gray-200 hover:bg-gray-300">{{ __('landing.complaint_cancel') }}</button><button type="submit" class="bg-green-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-green-700">{{ __('landing.complaint_submit') }}</button></div>
            </form>
        </div>
    </dialog>
    ...
    <footer class="bg-green-700 text-white py-10 mt-12">
        <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div><h4 class="font-bold text-lg">GreenTag</h4><p class="text-sm text-green-100 mt-2">{{ __('landing.footer_description') }}</p></div>
            <div><h5 class="font-semibold">{{ __('landing.footer_quick_links') }}</h5><ul class="mt-2 space-y-2 text-green-100"><li><a href="#fitur" class="hover:text-white">{{ __('navbar.about') }}</a></li><li><a href="#jadwal" class="hover:text-white">{{ __('navbar.schedule') }}</a></li><li><a href="#edukasi" class="hover:text-white">{{ __('navbar.education') }}</a></li><li><a href="#faq" class="hover:text-white">{{ __('landing.faq_title') }}</a></li></ul></div>
            <div><h5 class="font-semibold">{{ __('landing.footer_contact') }}</h5><ul class="mt-2 space-y-1 text-green-100"><li>📍 {{ __('landing.contact_address_value') }}</li><li>📧 info@uniguard.co.id</li><li>📞 +62 822-9990-0331</li></ul></div>
        </div>
        <div class="border-t border-green-600 mt-8 pt-4 text-center text-sm text-green-100">&copy; {{ date('Y') }} GreenTag. {{ __('landing.footer_copyright') }}</div>
    </footer>
