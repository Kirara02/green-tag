...
<body class="bg-gradient-to-b from-green-50 to-white text-gray-800">
    ...
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="bg-white/90 backdrop-blur shadow-lg rounded-2xl w-full max-w-md p-8 border border-green-100">
            ...
            <form method="POST" action="{{ route('login.perform') }}" class="space-y-5" x-data="{ show: false }">
                @csrf
                <div>
                ...
                <button type="submit" class="w-full bg-green-600 text-white py-2.5 rounded-lg font-semibold shadow hover:bg-green-700">Login</button>
            </form>
            <div class="text-center mt-4">
                <a href="/" class="text-sm text-gray-500 hover:text-gray-700">Kembali ke landing</a>
            </div>
        </div>
    </div>
