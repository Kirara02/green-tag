...
@section('content')
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-gray-600 max-w-2xl mx-auto">{{ __('public.educations_description') }}
            </p>
        </div>
                ...
                <div class="flex-1">
                    <div class="relative">
                        <input type="text" id="searchInput"
                            placeholder="{{ __('public.educations_search_placeholder') }}"
                ...
                <div class="lg:col-span-3 text-center py-16">
                    <div class="max-w-md mx-auto">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 mb-2">
                            {{ __('public.educations_empty_title') }}</h3>
