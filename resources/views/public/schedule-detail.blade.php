...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
            ...
            <div class="bg-gradient-to-r from-green-600 to-green-700 p-8 text-white">
                <div class="flex items-center justify-between mb-4">
                    @php
                        ...
                        $dayColor = $dayColors[strtolower($schedule->day)] ?? 'bg-gray-100 text-gray-800';
                    @endphp
                    <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold bg-white bg-opacity-20 text-white">
                        {{ $schedule->day }}
                    </span>
                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <div class="h-12 w-12 bg-blue-600 rounded-full flex items-center justify-center">
                                    <span class="text-white font-semibold text-lg">{{ substr($schedule->officerInCharge->name, 0, 1) }}</span>
                                </div>
                            </div>
                            <div class="ml-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach($relatedSchedules as $relatedSchedule)
                        <div class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-l-4 border-green-500">
                            <div class="flex items-center justify-between mb-4">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold {{ $dayColor }} border">
                                    {{ $relatedSchedule->day }}
                                </span>
                            ...
                            <h3 class="font-bold text-lg text-gray-900 mb-2">{{ $relatedSchedule->name }}</h3>
                            ...
                            <div class="bg-gray-50 rounded-lg p-4 mb-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="font-semibold text-gray-900">{{ $relatedSchedule->formatted_time }}</span>
                                </div>
                            </div>
        ...
        <div class="mt-12 text-center">
            <a href="{{ route('schedules.public.index') }}" class="inline-flex items-center px-6 py-3 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 transition-colors">
