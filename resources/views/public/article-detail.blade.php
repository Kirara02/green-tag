...
<div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <article class="bg-white rounded-xl shadow-lg overflow-hidden">
            @if($article->image)
                <div class="relative">
                    <img src="{{ asset('storage/' . $article->image) }}" alt="{{ $article->title }}" class="w-full h-64 md:h-80 object-cover">
            ...
            @else
                <div class="w-full h-64 md:h-80 bg-gradient-to-br from-green-50 to-green-100 flex items-center justify-center text-green-400">
                        ...
                        <article class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
                            @if($relatedArticle->image)
                                <div class="relative overflow-hidden">
                                    <img src="{{ asset('storage/' . $relatedArticle->image) }}" alt="{{ $relatedArticle->title }}" class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300">
                                    <div class="absolute top-4 left-4">
        ...
        <div class="mt-12 text-center">
            <a href="{{ route('educations.public.index') }}" class="inline-flex items-center px-6 py-3 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 transition-colors">
