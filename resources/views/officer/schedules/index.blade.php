                        ...
                        @forelse ($routes as $route)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    ...
                                    {{ date('H:i', strtotime($route->end_time)) }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    @if ($route->locations_count > 0)
                                        <span
                                            class="px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-800">{{ $route->locations_count }}
                                            Lokasi</span>
                                    @else
                                        <span
                                            class="px-2 py-1 text-xs font-semibold rounded-full bg-gray-100 text-gray-800">0
                                            Lokasi</span>
                                    @endif
                                </td>
                                <td
