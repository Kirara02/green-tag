                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="day" name="day" required
                                    ...
                                    <option value="Monday" @selected(old('day', $schedule->day) == 'Monday')>Senin
                                    </option>
                                    <option value="Tuesday" @selected(old('day', $schedule->day) == 'Tuesday')>Selasa
                                    </option>
                                    <option value="Wednesday" @selected(old('day', $schedule->day) == 'Wednesday')>Rabu
                                    </option>
                                    <option value="Thursday" @selected(old('day', $schedule->day) == 'Thursday')>Kamis
                                    </option>
                                    <option value="Friday" @selected(old('day', $schedule->day) == 'Friday')>Jumat
                                    </option>
                                    <option value="Saturday" @selected(old('day', $schedule->day) == 'Saturday')>Sabtu
                                    </option>
                                    <option value="Sunday" @selected(old('day', $schedule->day) == 'Sunday')>Minggu
                                    </option>
                                </select>
                            </div>
                            <div>
