<x-layout>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <form action="{{ route('officer.schedules.store') }}" method="POST">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name') }}" required placeholder="e.g., Rute Pagi Area Sakura"
                            ...
                            <div>
                                ...
                                <select id="day" name="day" required 
                                    ...
                                    <option value="Monday" @selected(old('day') == 'Monday')>Senin</option>
                                    <option value="Tuesday" @selected(old('day') == 'Tuesday')>Selasa</option>
                                    <option value="Wednesday" @selected(old('day') == 'Wednesday')>Rabu</option>
                                    <option value="Thursday" @selected(old('day') == 'Thursday')>Kamis</option>
                                    <option value="Friday" @selected(old('day') == 'Friday')>Jumat</option>
                                    <option value="Saturday" @selected(old('day') == 'Saturday')>Sabtu</option>
                                    <option value="Sunday" @selected(old('day') == 'Sunday')>Minggu</option>
                                </select>
                            </div>
                            <div>
            ...
            <div class="mt-8 flex items-center gap-4"><button type="submit" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 font-medium">Simpan Jadwal</button><a href="{{ route('officer.schedules.index') }}" class="px-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 font-medium">Batal</a></div>
        </form>
    </div>
</x-layout>