...
<x-layout :breadcrumb="$breadcrumb">
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Manajemen Tempat
                    Sampah</h1>
                <p class="text-sm text-gray-500 mt-1">Kelola semua aset tempat
                    sampah yang terdaftar di sistem.</p>
            </div>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td
                                    ...
                                    <a href="{{ route('officer.bins.qr_code', $bin->id) }}"
                                        target="_blank"
                                        class="text-green-600 hover:text-green-900">Tampil
                                        QR</a>
                        ...
                        @empty
                            <tr>
                                <td colspan="4"
                                    ...
                                    Tidak ada tempat sampah yang ditemukan.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
