...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white p-8 rounded-lg shadow-lg text-center">
        ...
        <p class="text-gray-600 mb-4">Bin Code: <span class="font-mono font-semibold">{{ $bin->code }}</span></p>
        ...
        <p class="mt-4 text-sm text-gray-500">Location: {{ $bin->location->name }}</p>
        ...
        <div class="mt-6 no-print">
            ...
            <a href="{{ route('officer.bins.index') }}" class="px-6 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300">
                Back to List
            </a>
        </div>
    </div>
