                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <select id="category" name="category" required
                                    ...
                                    <option value="Edukasi" @selected(old('category') == 'Edukasi')>Edukasi
                                    </option>
                                    <option value="Berita" @selected(old('category') == 'Berita')>Berita
                                    </option>
                                    <option value="Pengumuman" @selected(old('category') == 'Pengumuman')>
                                        Pengumuman</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select id="status" name="status" required
                                    ...
                                    <option value="draft" @selected(old('status', 'draft') == 'draft')>Draft
                                    </option>
                                </select>
                            </div>
                        </div>
