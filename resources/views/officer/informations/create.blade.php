<x-layout>
    ...
    <div class="max-w-4xl mx-auto">
        <h1 class="text-2xl font-semibold text-gray-900 mb-6">Tambah Artikel Baru</h1>
        ...
        <form action="{{ route('officer.informations.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <select id="category" name="category" required 
                                    ...
                                    <option value="Edukasi" @selected(old('category') == 'Edukasi')>Edukasi</option>
                                    <option value="Berita" @selected(old('category') == 'Berita')>Berita</option>
                                    <option value="Pengumuman" @selected(old('category') == 'Pengumuman')>Pengumuman</option>
                                </select>
                            </div>
                            <div>
            ...
            <div class="mt-8 flex items-center gap-4"><button type="submit" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 font-medium">Simpan Artikel</button><a href="{{ route('officer.informations.index') }}" class="px-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 font-medium">Batal</a></div>
        </form>
    </div>
