<x-layout>
    ...
    <div>
        ...
        <div class="mb-8">
            ...
            <p class="mt-1 text-sm text-gray-600">Selamat datang,
                {{ Auth::user()->name }}! Berikut adalah gambaran umum sistem.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <p class="mt-1 text-3xl font-semibold">
                    {{ $stats['total_officers'] }}</p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-md">
                <p class="text-sm font-medium text-gray-500">Total Tempat Sampah
                </p>
                <p class="mt-1 text-3xl font-semibold">{{ $stats['total_bins'] }}
                </p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-md">
                <p class="text-sm font-medium text-gray-500">Pengaduan Baru</p>
                <p class="mt-1 text-3xl font-semibold text-red-600">
                    {{ $stats['new_complaints'] }}</p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-md">
                <p class="text-sm font-medium text-gray-500">Pengaduan Selesai
                </p>
        ...
        <div class="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-3">
            <div class="lg:col-span-2 bg-white p-6 rounded-lg shadow-md">
                <h3 class="text-lg font-medium text-gray-900">Tren Pengaduan (7
                    Hari Terakhir)</h3>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                <h3 class="text-lg font-medium text-gray-900">Komposisi Kategori
                </h3>
        ...
        <div class="mt-8 bg-white shadow-md rounded-lg">
            <div class="p-6">
                <h3 class="text-lg font-medium text-gray-900">Aktivitas
                    Pengaduan Terbaru</h3>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <tbody class="divide-y">
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div class="text-sm text-gray-500">
                                        {{ $complaint->bin->location->name ?? 'N/A' }}
                                    </div>
                                </td>
                        ...
                        @empty
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 text-center text-gray-500" colspan="4">Tidak
                                    ada aktivitas
                                    pengaduan.</td>
                            </tr>
                        @endforelse
    ...
    @push('scripts')
        ...
        <script>
            ...
            const ctxComplaints = document.getElementById('complaintsChart').getContext(
                '2d');
            ...
            const ctxCategory = document.getElementById('categoryChart').getContext(
                '2d');
            new Chart(ctxCategory, {
                type: 'doughnut',
                data: {
                    labels: categoryLabels.map(label => label.replace(/_/g, ' ')
